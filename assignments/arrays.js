...
let carModels = inventory.map(function(element) {
...
// let bmwAndAudi = inventory.map(car => {
//   if (car.car_make === "Audi" || "BMW") {
//     // console.log(car.car_make);
//     return carArray.unshift(car);
//   }}
// );
